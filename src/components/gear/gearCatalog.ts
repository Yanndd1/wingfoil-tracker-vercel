...
export const GEAR_CATALOG = {
  ...
  boards: {
    ...
    Gong: {
      ...
      'Lethal FSP Pro': ['4\'2 / 35L', '4\'4 / 45L', '4\'6 / 55L', '4\'8 / 65L', '4\'10 / 75L', '5\'0 / 85L', '5\'3 / 95L', '5\'6 / 100L', '6\'0 / 120L'],
      'Racer FSP Pro': ['5\'0 / 69L', '5\'2 / 79L', '5\'4 / 89L', '5\'6 / 99L', '5\'8 / 109L'],
      'Kube FSP Pro': ['4\'4 / 65L'],
    },
    Korvenn: {
      'Wing Glider Carbon': ['4\'7 / 55.8L', '5\'0 / 70.2L'],
      'Pro Glider': ['4\'10', '4\'11'],
    },
    Takuma: {
  ...
  // =============================================================================
  wings: {
    // 2024-2026 lineup verified on official sites + authorized retailers
    // (Apr 2026 cutoff). Outdated names (Plus2, Pulse X, ADX Wing-Surfer,
    // Mantis V4, SuperWingX, RS Wing, Sprint, Concept-K, Wing Performer)
    // were renamed or dropped from current ranges.
    Gong: {
      'Plus': ['4m²', '5m²', '6m²', '7m²'],
      'SuperPower': ['3m²', '4m²', '5m²', '6m²', '7m²'],
      'Pulse': ['3m²', '3.5m²', '4m²', '4.5m²', '5m²', '5.5m²', '6m²'],
      'Pulse Race Aramid CZ': ['3m²', '4m²', '5m²', '6m²'],
      'Droid': ['3m²', '3.5m²', '4m²', '4.5m²', '5m²', '5.5m²', '6m²', '6.5m²'],
      'Droid Boom': ['3m²', '4m²', '5m²'],
      'Neutra': ['2m²', '2.5m²', '3m²', '3.5m²', '4m²', '4.5m²', '5m²', '5.5m²'],
      'Neutra Boom': ['3m²', '4m²', '5m²'],
      'Neutra UPE Aramid': ['3m²', '4m²', '5m²'],
    },
    Duotone: {
      'Slick': ['2.5m²', '3m²', '3.5m²', '4m²', '4.5m²', '5m²', '5.5m²', '6m²', '7m²'],
      'Unit': ['2m²', '2.5m²', '3m²', '3.5m²', '4m²', '4.5m²', '5m²', '5.5m²', '6m²', '6.5m²'],
      'Unit SLS': ['2m²', '2.5m²', '3m²', '3.5m²', '4m²', '4.5m²', '5m²', '5.5m²', '6m²', '6.5m²'],
      'Unit D/LAB': ['3m²', '3.5m²', '4m²', '4.5m²', '5m²', '5.5m²', '6m²'],
      'Unit SLS Concept Blue': ['2m²', '2.5m²', '3m²', '3.5m²', '4m²', '4.5m²', '5m²', '5.5m²', '6m²', '6.5m²'],
      'Float SLS': ['2m²', '2.5m²', '3m²', '3.5m²', '4m²', '4.5m²', '5m²', '5.5m²'],
      'Ventis FS': ['3.5m²', '4m²', '4.5m²', '5m²', '5.5m²', '6m²'],
      'Ventis FS D/LAB': ['3.5m²', '4m²', '4.5m²', '5m²', '5.5m²', '6m²'],
    },
    'F-One': {
      'Strike V5': ['2m²', '2.5m²', '3m²', '3.5m²', '4m²', '4.5m²', '5m²', '5.5m²'],
      'Strike V5 Aluula': ['2.5m²', '3m²', '3.5m²', '4m²', '4.5m²', '5m²', '5.5m²'],
      'Strike CWC': ['6m²', '7m²', '8m²', '9m²'],
      'Strike V5 CWC Aluula': ['6m²', '7m²', '8m²', '9m²'],
    },
    Naish: {
      'ADX': ['2m²', '2.5m²', '3m²', '3.5m²', '4m²', '4.5m²', '5m²', '5.5m²', '6m²', '6.5m²', '7m²'],
      'ADX Nvision': ['3m²', '3.5m²', '4m²', '4.5m²', '5m²', '5.5m²', '6m²'],
      'Wing-Surfer MK4': ['2.5m²', '3m²', '3.5m²', '4m²', '4.5m²', '5m²', '5.5m²', '6m²', '6.5m²', '7.5m²'],
      'Atom': ['7m²', '8m²'],
    },
    Cabrinha: {
      'Mantis V5': ['2m²', '2.5m²', '3m²', '3.5m²', '4m²', '4.5m²', '5m²', '5.5m²', '6m²'],
      'Crosswing X3': ['2m²', '2.5m²', '3m²', '3.5m²', '4m²', '4.5m²', '5m²', '6m²', '7m²'],
    },
    North: {
      'Loft Pro': ['2m²', '2.5m²', '3m²', '3.5m²', '4m²', '4.5m²', '5m²', '5.5m²', '6m²', '7m²', '8m²'],
      'Mode Pro': ['3m²', '3.5m²', '4m²', '4.5m²', '5m²', '5.5m²'],
      'Mode Ultra': ['3m²', '3.5m²', '4m²', '4.5m²', '5m²', '5.5m²'],
      'Nova': ['2.5m²', '3m²', '3.5m²', '4m²', '4.5m²', '5m²', '5.5m²', '6m²'],
      'Nova Pro': ['2.5m²', '3m²', '3.5m²', '4m²', '4.5m²', '5m²', '5.5m²'],
    },
    Ozone: {
      'Flux V2': ['2.4m²', '3m²', '3.6m²', '4.3m²', '5m²', '5.7m²'],
      'Flux V2 Ultra-X': ['3.5m²', '4m²', '4.5m²', '5m²', '6m²', '6.5m²', '7.3m²'],
      'Flow V2': ['2.4m²', '3m²', '3.6m²', '4.3m²', '5m²', '5.7m²'],
    },
    Reedin: {
      'SuperNatural': ['2m²', '2.5m²', '3m²', '3.5m²', '4m²', '4.5m²', '5m²', '5.5m²', '6m²', '6.5m²'],
      'SuperNatural SSD': ['3m²', '3.5m²', '4m²', '4.5m²', '5m²', '5.5m²', '6m²'],
      'HyperNatural': ['3m²', '3.5m²', '4m²', '4.5m²', '5m²', '5.5m²', '6m²'],
    },
    Ensis: {
      'Score V3': ['2.8m²', '3.5m²', '4m²', '4.5m²', '5.2m²', '5.9m²', '6.6m²'],
      'Score Limited Edition': ['3.5m²', '4m²', '4.5m²', '5.2m²', '5.9m²'],
    },
    Eleveight: {
      'WFS V6': ['2m²', '3m²', '3.5m²', '4m²', '4.5m²', '5m²', '5.5m²', '6.5m²'],
      'WFS Pro': ['3.5m²', '4.5m²', '5.5m²'],
    },
    Sroka: {
      'Wing V4': ['3m²', '4m²', '5m²', '6m²'],
    },
    Slingshot: {
      'SlingWing V5': ['2m²', '2.5m²', '3m²', '3.5m²', '4m²', '4.5m²', '5m²', '5.5m²', '6m²', '6.5m²'],
      'SlingWing V6': ['2m²', '2.5m²', '3m²', '3.5m²', '4m²', '4.5m²', '5m²', '5.5m²', '6m²', '6.5m²'],
    },
    Armstrong: {
      'A-Wing XPS Mk II': ['2m²', '2.5m²', '3m²', '3.5m²', '4m²', '4.5m²', '5m²', '5.5m²', '6m²', '6.5m²'],
    },
    Korvenn: {
      'Wing': ['4m²', '5m²', '6m²', '7m²'],
    },
  ...
  // =============================================================================
  // HARNESSES — wing-specific waist harnesses (sizes XS-XL)
  // =============================================================================
  harnesses: {
    Manera: {
      'Lift Wing Harness': ['XS', 'S', 'S+', 'M', 'M+', 'L', 'XL'],
      'Pocket Wing Belt': ['XXS', 'XS', 'S', 'M', 'L', 'XL', 'XXL'],
    },
    Mystic: {
      'Majestic Wing Harness': ['XS', 'S', 'M', 'L', 'XL'],
      'Majestic X Wing Harness': ['XS', 'S', 'M', 'L', 'XL'],
    },
    Ion: {
      'Apex Waist Harness': ['46/XS', '48/S', '50/M', '52/L', '54/XL', '56/XXL'],
      'Nova Waist Harness': ['XS', 'S', 'M', 'L', 'XL'],
      'Arc Wing Harness': ['XS', 'S', 'M', 'L', 'XL'],
    },
    Prolimit: {
      'Vapor Waist Harness': ['XS', 'S', 'M', 'L', 'XL'],
      'Hybrid Waist Harness': ['XS', 'S', 'M', 'L', 'XL'],
      'Type-T Waist Harness': ['XS', 'S', 'M', 'L', 'XL'],
    },
  },
} as const;
